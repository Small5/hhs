...
public class TblClimateScenarioYear{
	...
	public TblClimateScenarioYear() {
	}

	public TblClimateScenarioYear(String username,String fldWatershedCode, String fldCountyCode, String fldCRPType,
	...
	public String toString() {
		return "TblClimateScenarioYear [id=" + id + ", username=" + username + ", fldWatershedCode=" + fldWatershedCode
